  ...
  return (
    ...
    >
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        ...
        <div className="relative bg-[#132731] flex flex-col justify-center px-10 py-32 sm:px-16 lg:px-20 xl:px-24 overflow-hidden">
          {/* Decorative background circle */}
          <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] rounded-full bg-[#d4af37]/5 blur-3xl pointer-events-none" />
          ...
          <motion.div {...FADE_UP(0.2)} className="flex items-center gap-3 mb-8">
            ...
            <span className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#d4af37] font-body">Private Advisory</span>
          </motion.div>
          ...
          <motion.h1 {...FADE_UP(0.3)} className="font-heading font-light uppercase text-white leading-[1.1] tracking-tight text-[clamp(2.2rem,4vw,3.5rem)] mb-6">
            Let&apos;s Start a<br />
            <span className="text-[#d4af37] font-semibold">Conversation.</span>
          </motion.h1>
          ...
          <motion.div {...FADE_UP(0.5)} className="flex flex-col gap-8">
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <a href="mailto:info@infraguru.in" className="text-sm text-white/70 font-light hover:text-[#d4af37] transition-colors">
                  info@infraguru.in
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <a href="tel:+919090656575" className="text-sm text-white/70 font-light hover:text-[#d4af37] transition-colors">
                  +91 90 90 65 65 75
                </a>
              </div>
            </div>
          ...
          {submitted ? (
            ...
            >
              ...
              <h3 className="mb-3 font-heading text-2xl font-light text-neutral-900 uppercase tracking-widest">
                Request <span className="font-semibold text-[#d4af37]">Received</span>
              </h3>
            ...
            <motion.div {...FADE_UP(0.4)}>
              ...
              <div className="mb-10">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[9px] font-bold tracking-[0.3em] uppercase text-[#d4af37] font-body">Send a Message</span>
                </div>
                <h2 className="font-heading font-light uppercase text-neutral-900 text-[clamp(1.5rem,2.5vw,2.2rem)] leading-tight tracking-tight">
                  Book a <span className="font-semibold text-[#132731]">Consultation</span>
                </h2>
              </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-2 group">
                    <label className="text-[9px] font-bold text-neutral-400 uppercase tracking-[0.2em] group-focus-within:text-[#d4af37] transition-colors">
                      First Name
                    </label>
                    <input
                      type="text" required
                      placeholder="John"
                      className="border-b border-neutral-200 py-2.5 focus:border-[#d4af37] outline-none transition-colors bg-transparent text-sm font-light text-neutral-900 placeholder-neutral-300"
                    />
                  </div>
                  <div className="flex flex-col gap-2 group">
                    <label className="text-[9px] font-bold text-neutral-400 uppercase tracking-[0.2em] group-focus-within:text-[#d4af37] transition-colors">
                ...
                <div className="flex flex-col gap-2 group">
                  ...
                  <select
                    ...
                    className="border-b border-neutral-200 py-2.5 focus:border-[#d4af37] outline-none transition-colors bg-transparent text-sm font-light text-neutral-900 appearance-none cursor-pointer"
                  >
                ...
                <div className="flex flex-col gap-2 group">
                  ...
                  <textarea
                    ...
                    className="border-b border-neutral-200 py-2.5 focus:border-[#d4af37] outline-none transition-colors bg-transparent text-sm font-light text-neutral-900 resize-none placeholder-neutral-300"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="mt-2 self-start bg-[#132731] text-white text-[10px] font-bold uppercase tracking-[0.2em] px-10 py-4 rounded-full hover:bg-[#d4af37] transition-all duration-300 shadow-lg hover:shadow-[0_10px_30px_rgba(212,175,55,0.3)]"
                >
                  Submit Request
                </button>
              </form>
