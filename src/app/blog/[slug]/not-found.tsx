...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-bg-soft px-6 text-center">
      ...
      />
      <span className="eyebrow justify-center">Article Not Found</span>
      <h1 className="mb-5 max-w-lg text-[clamp(2rem,4vw,3rem)] text-primary-dark">
        This Page Isn&rsquo;t On Record
      </h1>
      <p className="mb-10 max-w-md text-[1.02rem] leading-[1.7] text-muted">
        The article you&rsquo;re looking for may have been moved or never existed. Let&rsquo;s get you
        back to the Journal.
      </p>
      <SealLink href="/blog" className="btn-primary rounded-full">
