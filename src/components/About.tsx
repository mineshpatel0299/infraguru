          ...
          >
            ...
            <div className="flex flex-col gap-4 text-neutral-300 text-base sm:text-lg font-light leading-relaxed mt-4">
              <p>
                ...
                of the real estate market with unmatched precision and deep local insight.
              </p>
              <p>
                Whether you are acquiring a flagship commercial asset, seeking the perfect 
                residential sanctuary, or structuring a joint development, we provide the 
                strategic clarity you need to move forward with absolute confidence.
              </p>
            </div>
